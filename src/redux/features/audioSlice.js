...
const initialState = {
    ...
    srcAudio: 'https://res.cloudinary.com/cockbook/video/upload/v1673874022/single/y2mate.com_-_Glass_Animals_Heat_Waves_320kbps_kvhuq3.mp3',
    srcRadio: '',
    currentTime: 0,
    duration: 324,
...
const audioSlice = createSlice({
    ...
    reducers: {
        ...
        setNewInfoSongRebuild: (state, action) => {}
    },
});
